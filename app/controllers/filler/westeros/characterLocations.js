const mongoose = require('mongoose'),
    ...
    CharacterLocationScraper = require('../../../controllers/scraper/westeros/characterLocation');
...
class CharacterLocationFiller {
    ...
    async clearAll() {
        ...
        return CharacterLocations.deleteMany({}, (err, data) => {
            if (err) {
    ...
    async insertAll(data) {
        ...
        try {
            return CharacterLocations.insertMany(data, (err, docs) => {
                if (err) {
